  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const needBasedResponse = await fetch('http://192.168.82.26/FinancialAidAllocation/api/Admin/AcceptedApplication');
        const meritBasedResponse = await fetch('http://192.168.82.26/FinancialAidAllocation/api/Admin/AcceptedApplication');
